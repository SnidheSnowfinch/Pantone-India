    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12">
        ...
        <div class="about-text">
          ...
          <ul>
            <li><img src="bootstrap/images/check-circle.png" alt="" class="me-2">Tech Partnerships Across Pan-Asia</li>
      ...
      <p>Our service operation and customer handling system are strongly backed by scientific tools and deep market research for total quality management system. we are possessing state of the art research and development facilities inhouse where we are working on future trends in textile machinery and cutting-edgetechnologies.</p>
        <p>We have technology partners across pan Asia region. We have extended our feet throughout the market in very short span. We are introducing customers to the world of limitless design possibilities.</p>
